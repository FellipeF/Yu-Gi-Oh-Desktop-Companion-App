...
from data.other_duelists.other_duelists_decks_cover_cards import OTHER_DUELISTS_DECKS_COVER_CARDS
...
from data.duel_monsters_anime.duel_monsters_decks_cover_cards import DUEL_MONSTERS_DECK_COVER_CARDS
